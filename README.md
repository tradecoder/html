...
When you will mostly complete HTML and CSS at w3schools, to advance to your learning don't forget to join here [freeCodeCamp](https://freecodecamp.com). It will help you to guide yourself on the way to become a real Developer. You just need to be consistent in coding, no matter if it's less or more a day. 
